...
// Sphere Map Texture
  texture2D FlowMap
< string ResourceName = "Flow.png"; >;
	sampler FlowMap_Sampler = sampler_state {
    texture   = <FlowMap>;
...
//////////////////////////////////////////////////
	...
	float4 Flow		= tex2D( FlowMap_Sampler, IN.UV );
	
	//Flow.xy = (Flow.xy * 2.0) - 1.0;
	
	float2 flipped = Flow.xy;
	
	float4 Color = float4(Flow.xy * 0.5 + 0.5, 1.0, 1.0);
    Color.a				*= TexColor.a;
    Color.a				*= alphaM;
